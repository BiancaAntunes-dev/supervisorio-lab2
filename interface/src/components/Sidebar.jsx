...
<<<<<<< HEAD
        alt="Logo braço mecânico robô" 
=======
        alt="logo de braço mecânico robô"
>>>>>>> 434341da77e18cdf79232214f0a37e9933bbd060
    ...
    />
            ...
            {menuItems.map((item) => {
              ...
              return (
                <li key={item.id}>
                  ...
                  >
                    <Icon className={`w-4 h-4 flex-shrink-0 ${isActive ? 'text-blue-600' : 'text-slate-500'}`} aria-hidden />
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            type="button"
            aria-label="Encerrar sessão e sair da aplicação"
            className="flex items-center gap-2 text-slate-500 hover:text-red-600 text-sm transition-colors w-full font-medium"
          >
